...
| Active brief | Current | `docs/briefs/010-bad-lower-back-resolver-safety.md` |
...
| Product implementation | EOD completion/testing active | M0-M5 complete; a resumed EOD completion/testing pass is active from the current brief. |
