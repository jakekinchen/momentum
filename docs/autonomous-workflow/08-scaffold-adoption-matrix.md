...
| Stop sentinel | Present | `<stop-orchestrator/>`; reviewer STOP for EOD completion/testing; executor product slices are stopped until fresh human direction. |
...
| Product implementation | EOD completion/testing stopped | M0-M5 complete; resumed EOD validation was green before reviewer STOP. |
