...
public struct EngineTraceRecorder {
    ...
    private static func selectedProducedValueKeys(program: ExerciseProgram, phaseSignalName: String) -> [String] {
        ...
        keys.insert("arm_spread")
        keys.insert("arm_symmetry")
        keys.insert("curl_elbow")
        keys.insert("hip_flexion")
        keys.insert("jack_spread")
        keys.insert("knee")
        keys.insert("knee_angle")
        keys.insert("leg_spread")
        keys.insert("elbow_angle")
        keys.insert("pike_angle")
        keys.insert("shoulder_stack")
        keys.insert("stance_knee")
        keys.insert("torso_tilt")
        keys.insert("knee_symmetry")
        keys.insert("upper_arm_tilt")
